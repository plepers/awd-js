!function(a) {
    ...
    return function a(b, c, d) {
        ...
        4: [ function(a, module, exports) {
            ...
            var c = a("optx/_awdlib").get(), d = c.consts, e = c.BaseElement, f = c.userAttr, g = a("optx/extInfos"), h = a("optx/Container"), i = 1, j = 2, k = 3, l = 4, m = 5, n = 6, o = {};
        ...
        5: [ function(a, module, exports) {
            function b() {
                this.data = null, this.mime = "application/binary", this.uri = "";
            }
        ...
        12: [ function(a, module, exports) {
            var b = a("optx/_awdlib").get(), c = b.awdString, d = b.consts, e = b.BaseElement, f = b.userAttr, g = a("optx/extInfos"), h = a("optx/FileData"), i = e.createStruct(g.OPTX_TEXTURE, g.URI, {
                init: function() {
                    this.model = d.MODEL_TEXTURE, this.name = "", this.extras = new f(), this.fileData = null, 
                    this.uri = null;
                },
                read: function(a) {
                    this.name = c.read(a);
                    var b = a.U8(), d = !!(1 & b);
                    d ? (this.fileData = new h(), this.fileData.read(a)) : this.uri = c.read(a), this.extras.read(a);
                },
                write: void 0,
                getDependencies: function() {
                    return null;
