    ...
    return function a(b, c, d) {
        ...
        9: [ function(require, module, exports) {
            function a(a) {
                ...
                for (var k = 0; k < i._l; k++) i.props[k] = a.F32();
                return i;
            }
            function b(a, b) {
                this._l = 2, this._id = p, this.props = [ a, b ];
            }
            function c(a, b) {
                this._l = 4, this._id = q, a = a || [ 1, 1, 1 ], this.props = [ a[0], a[1], a[2], b ];
            }
            function d(a, b) {
                this._l = 5, this._id = r, a = a || [ 1, 1, 1, 1 ], this.props = [ a[0], a[1], a[2], a[3], b ];
            }
            function e(a) {
                this._l = 3, this._id = s, a = a || [ 1, 1, 1 ], this.props = [ a[0], a[1], a[2] ];
            }
            function f(a, b, c) {
                this._l = 9, this._id = t, a = a || [ 1, 1, 1 ], b = b || [ 1, 1, 1 ], c = c || [ 1, 1, 1 ], 
                this.props = [ a[0], a[1], a[2], b[0], b[1], b[2], c[0], c[1], c[2] ];
            }
            function g() {
                this._l = 0, this._id = u, this.props = [];
            }
            function h() {
                this._l = 0, this._id = v, this.props = [];
            }
            var i = require("awdlib"), j = i.consts, k = i.BaseElement, l = i.userAttr, m = i.awdString, n = require("optx/extInfos"), o = k.createStruct(n.OPTX_POST, n.URI, {
                init: function() {
                    this.model = j.MODEL_GENERIC, this.name = "", this.effects = [], this.extras = new l();
                },
                read: function(b) {
                    this.name = m.read(b), this.effects = [];
            ...
            }, g.prototype = {}, h.prototype = {}, o.Sharpen = b, o.Bloom = c, o.Vignette = d, 
            o.Saturation = e, o.Contrast = f, o.Reinhard = g, o.Hejl = h, module.exports = o;
        }, {
            awdlib: "awdlib",
            "optx/extInfos": 13
        } ],
