!function(a) {
    ...
    return function a(b, c, d) {
        ...
        1: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.consts, d = b.BaseElement, e = b.userAttr, f = a("optx/extInfos"), g = a("optx/Container"), h = 0, i = 1, j = d.createStruct(f.OPTX_CAMERA, f.URI, {
                init: function() {
        ...
        2: [ function(a, module, exports) {
            ...
            var c = a("awdlib"), d = c.awdString, e = c.consts, f = c.BaseElement, g = c.userAttr, h = a("optx/extInfos"), i = [ "r", "g", "b", "a" ], j = f.createStruct(h.OPTX_COMPOSITE_TEXTURE, h.URI, {
                init: function() {
        ...
        3: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.awdString, d = b.consts, e = b.BaseElement, f = b.vec3, g = b.matrix, h = e.createStruct(-1, null, {
                init: function() {
        ...
        4: [ function(a, module, exports) {
            ...
            var c = a("awdlib"), d = c.consts, e = c.BaseElement, f = c.userAttr, g = a("optx/extInfos"), h = a("optx/Container"), i = 1, j = 2, k = 3, l = 4, m = 5, n = 6, o = {};
            ...
            var p = 0, q = e.createStruct(g.OPTX_ENV, g.URI, {
                init: function() {
            ...
            h.extend(q.prototype), module.exports = q;
        }, {
            awdlib: "awdlib",
            "optx/Container": 3,
            "optx/extInfos": 13
        ...
        5: [ function(a, module, exports) {
            ...
            var f = a("awdlib"), g = f.BaseElement, h = f.consts, i = f.awdString, j = f.userAttr, k = f.properties, l = a("optx/extInfos"), m = g.createStruct(l.OPTX_GEOM, l.URI, {
                init: function() {
        ...
        6: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.consts, d = b.BaseElement, e = b.userAttr, f = b.properties, g = a("optx/extInfos"), h = a("optx/Container"), i = 1, j = 2, k = 3, l = 4, m = 5, n = 6, o = {};
        ...
        7: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.awdString, d = b.consts, e = b.BaseElement, f = b.userAttr, g = b.properties, h = a("optx/extInfos"), i = 1, j = 2, k = 3, l = 4, m = 5, n = 6, o = 7, p = 8, q = 9, r = 10, s = 11, t = 12, u = 13, v = 14, w = 15, x = 16, y = 17, z = 18, A = 19, B = 20, C = 21, D = 22, E = {};
        ...
        8: [ function(a, module, exports) {
            ...
            var c = a("awdlib"), d = c.consts, e = c.BaseElement, f = c.userAttr, g = c.properties, h = a("optx/extInfos"), i = a("optx/Container"), j = {
                cullBackFaces: 1,
                castShadows: 2,
                bounds: 10
        ...
        9: [ function(a, module, exports) {
            function b(a) {
                ...
                switch (d) {
                  ...
                  default:
                    throw new Error("unknown post effect type " + d);
                }
                for (var k = 0; k < b._l; k++) b.props[k] = a.F32();
                return b;
            }
            function c(a, b) {
            ...
            var k = a("awdlib"), l = k.consts, m = k.BaseElement, n = k.userAttr, o = k.awdString, p = a("optx/extInfos"), q = m.createStruct(p.OPTX_POST, p.URI, {
                init: function() {
        ...
        10: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.consts, d = b.BaseElement, e = b.userAttr, f = a("optx/extInfos"), g = a("optx/Container"), h = 0, i = 1, j = d.createStruct(f.OPTX_SKY, f.URI, {
                init: function() {
        ...
        11: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.awdString, d = b.consts, e = b.BaseElement, f = b.userAttr, g = a("optx/extInfos"), h = e.createStruct(g.OPTX_TEXTURE, g.URI, {
                init: function() {
        ...
        12: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.extension, d = a("optx/Geometry"), e = a("optx/Mesh"), f = a("optx/Material"), g = a("optx/Texture"), h = a("optx/CompositeTexture"), i = a("optx/Light"), j = a("optx/Env"), k = a("optx/Sky"), l = a("optx/Camera"), m = a("optx/Post"), n = a("optx/extInfos"), o = [ d, e, f, g, h, i, j, k, l, m ], p = n;
        ...
        awdlib_optx: [ function(a, module, exports) {
            var b = a("optx/Camera"), c = a("optx/CompositeTexture"), d = a("optx/Container"), e = a("optx/Env"), f = a("optx/Geometry"), g = a("optx/Light"), h = a("optx/Material"), i = a("optx/Mesh"), j = a("optx/Post"), k = a("optx/Sky"), l = a("optx/Texture"), m = a("optx/ext"), n = a("optx/extInfos"), o = {
                Camera: b,
                CompositeTexture: c,
                Container: d,
                Env: e,
