!function(a) {
    ...
    return function a(b, c, d) {
        ...
        4: [ function(a, module, exports) {
            ...
            var d = a("optx/_awdlib").get(), e = d.consts, f = d.BaseElement, g = d.userAttr, h = a("optx/extInfos"), i = a("optx/Container"), j = 0, k = 1, l = f.createStruct(h.OPTX_ENV, h.URI, {
                init: function() {
            ...
            i.extend(l.prototype), module.exports = l;
        }, {
            "optx/Container": 3,
            "optx/_awdlib": 13,
            "optx/extInfos": 15
        ...
        5: [ function(a, module, exports) {
            ...
            b.prototype.read = function(a) {
                ...
                d.write(this.mime, a), d.write(this.uri, a), a.U32(this.data.length), a.writeSub(this.data);
            }, module.exports = b;
        }, {
            "optx/_awdlib": 13
        } ],
        ...
        7: [ function(a, module, exports) {
            ...
            var p = d.createStruct(g.OPTX_LIGHT, g.URI, {
                ...
                setupProps: function(a) {
                    ...
                    a.set(m, this.spotSharpness), a.set(n, this.shadow);
                },
                readProps: function(a) {
                    ...
                    this.spotAngle = a.get(l, this.spotAngle), this.spotSharpness = a.get(m, this.spotSharpness), 
        ...
        12: [ function(a, module, exports) {
            ...
            var p = e.createStruct(h.OPTX_TEXTURE, h.URI, {
                ...
                write: function(a) {
                    c.write(this.name, a);
                    var b = null !== this.fileData, d = +b;
                    if (a.U8(d), b) this.fileData.write(a); else {
                        if (null === this.uri) throw new Error("Texture have no embedData nor uri");
                        c.write(this.uri, a);
                    }
                    var e = new f(o);
                    this.setupProps(e), e.write(a), this.extras.write(a);
                },
                setupProps: function(a) {
                    var b = this.infos;
                    a.set(j, b.width), a.set(k, b.height), a.set(l, b.glinternalFormat), a.set(m, b.glformat), 
                    a.set(n, b.gltype);
                },
                readProps: function(a) {
                    var b = this.infos;
