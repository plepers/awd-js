!function(a) {
    ...
    return function a(b, c, d) {
        ...
        9: [ function(require, module, exports) {
            ...
            var k = require("awdlib"), l = k.consts, m = k.BaseElement, n = k.userAttr, o = k.awdString, p = require("optx/extInfos"), q = m.createStruct(p.OPTX_POST, p.URI, {
                init: function() {
                    this.model = l.MODEL_GENERIC, this.name = "", this.effects = [], this.extras = new n();
                },
                read: function(b) {
                    this.name = o.read(b), this.effects = [];
                    for (var c = b.U8(), d = 0; c > d; d++) this.effects.push(a(b));
                    this.extras.read(b);
                },
                write: function(a) {
                    o.write(this.name, a);
                    var c = this.effects.length;
                    a.U8(c);
                    for (var d = 0; c > d; d++) b(this.effects[d], a);
                    this.extras.write(a);
                },
                getDependencies: function() {
                    return null;
