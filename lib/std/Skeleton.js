!function() {
    ...
    var Properties = require("../types/properties"), AwdString = require("../types/awdString"), Consts = require("../consts"), UserAttr = require("../types/userAttr"), Matrix4 = require("../types/matrix"), BaseElement = require("../BaseElement"), Skeleton = BaseElement.createStruct(Consts.SKELETON, null, {
        ...
        write: function(writer) {
            AwdString.write(this.name, writer), writer.U16(this.joints.length), this.props.write(writer);
            for (var i = 0; i < this.joints.length; i++) this.joints[i].write(this.awd, writer);
    ...
    SkeletonJoint.prototype = {
        ...
        write: function(awd, writer) {
            writer.U16(this.id), writer.U16(this.parentId), AwdString.write(this.name, writer), 
            this.bindPose.write(awd, writer), this.props.write(writer), this.extras.write(writer);
        }
