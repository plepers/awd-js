!function() {
    var Consts = require("../consts"), Properties = require("../types/properties"), BaseElement = require("../BaseElement"), DEFAULT = "unknown", Metadata = BaseElement.createStruct(Consts.METADATA, null, {
        ...
        write: function(writer) {
            ...
            props.set(1, this.timeStamp), props.set(2, this.encoderName), props.set(3, this.encoderVersion), 
            props.set(4, this.generatorName), props.set(5, this.generatorVersion), props.write(writer);
        },
        toString: function() {
