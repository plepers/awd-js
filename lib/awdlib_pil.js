!function(a) {
    ...
    return function a(b, c, d) {
        ...
        1: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.BaseElement, d = b.bufferReader, e = b.consts, f = a("std/Geometry"), g = a("pil/extInfos"), h = function() {
            ...
            h.HEAD_SIZE = 6, h.prototype = {
                ...
                write: function(a) {
                    ...
                    for (a.U8(d.length), a.U8(this.ftype), b = 0, c = d.length; c > b; b++) {
                        var e = d[b];
                        a.U8(e.type), a.U8(e.len);
                    }
                    var g = f.getTypeSize(this.ftype), h = g - (a.ptr + 5) % g;
                    for (a.U8(h), b = 0; h > b; b++) a.U8(0);
                    var i = a.skipBlockSize(), j = f.getWriteFunc(this.ftype, a), k = this.data;
        ...
        2: [ function(a, module, exports) {
            var b = a("awdlib"), c = b.extension, d = a("pil/InterleavedGeometry"), e = a("pil/extInfos"), f = [ d ], g = e;
        ...
        awdlib_pil: [ function(a, module, exports) {
            var b = a("pil/InterleavedGeometry"), c = a("pil/ext"), d = a("pil/extInfos"), e = {
                InterleavedGeometry: b,
                ext: c,
                extInfos: d
            };
            module.exports = e;
