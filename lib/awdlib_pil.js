    ...
    return function a(b, c, d) {
        ...
        1: [ function(a, module, exports) {
            ...
            var f = a("types/properties"), g = a("types/awdString"), h = a("consts"), i = a("types/userAttr"), j = a("BaseElement"), k = a("./extInfos"), l = j.createStruct(k.COMPACT_SKEL_ANIM, k.URI, {
                ...
                write: function(a) {
                    g.write(this.name, a), a.U16(this.numFrames), a.U16(this.numBones), this.props.write(a);
                    var b = 4 - (a.ptr + 5) % 4;
                    a.U8(b);
                    for (var c = 0; b > c; c++) a.U8(0);
                    var d = new Int8Array(this.data.buffer, this.data.byteOffset, this.data.byteLength);
                    a.writeSub(d), this.extras.write(a);
                },
        ...
        2: [ function(a, module, exports) {
            ...
            b.prototype = {
                ...
                write: function(a) {
                    f.write(this.name, a), a.U8(this.bytesize), a.U16(this.gltype);
                    var b = 7 & this.numcomps;
                    this.normalize && (b = 8 | b), a.U8(b);
                }
            };
            var p = function() {
            ...
            p.Attribute = b, p.prototype = {
                ...
                write: function(a) {
                    ...
                    for (a.U8(d.length), a.U16(this.buffertype), b = 0, c = d.length; c > b; b++) {
                        var e = d[b];
                        e.write(a);
                    }
                    var f = 4, g = f - (a.ptr + 5) % f;
                    for (a.U8(g), b = 0; g > b; b++) a.U8(0);
                    a.U32(this.data.byteLength), a.writeSub(this.data);
                }
            };
            var q = function(a) {
                switch (a) {
