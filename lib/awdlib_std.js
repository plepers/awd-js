!function(a) {
    ...
    return function a(b, c, d) {
        ...
        1: [ function(a, module, exports) {
            !function() {
                var b = a("types/userAttr"), c = a("types/awdString"), d = a("types/vec3"), e = a("types/matrix"), f = a("consts"), g = a("BaseElement"), h = g.createStruct(f.CONTAINER, null, {
                    init: function() {
        ...
        3: [ function(a, module, exports) {
            !function() {
                var b = a("types/properties"), c = a("types/awdString"), d = a("consts"), e = a("BaseElement"), f = e.createStruct(d.MATERIAL, null, {
                    init: function() {
                        this.name = "", this.model = d.MODEL_MATERIAL;
                    },
                    read: function(a) {
                        this.name = c.read(a), this.type = a.U8(), this.numMethods = a.U8();
                    ...
                    write: function(a) {
                        c.write(this.name, a), a.U8(this.type), a.U8(this.numMethods), this.props.write(a);
                    },
                    toString: function() {}
                });
                module.exports = f;
        ...
        7: [ function(a, module, exports) {
            !function() {
                var b = a("types/properties"), c = a("types/awdString"), d = a("consts"), e = a("types/userAttr"), f = a("BaseElement"), g = f.createStruct(d.TEXTURE, null, {
                    init: function() {
                        this.name = "", this.type = 0, this.url = null, this.data = null, this.extras = new e(), 
                        this.model = d.MODEL_TEXTURE;
                    },
                    read: function(a) {
                        this.name = c.read(a), this.type = a.U8();
                        var d = a.U32();
                        0 === this.type ? (this.url = a.readUTFBytes(d), console.log(this.url)) : (this.data = new ArrayBuffer(d), 
                        a.readBytes(this.data, d)), new b().read(a), this.extras.read(a);
                    },
                    write: function(a) {
                        c.write(this.name, a), a.U8(this.type);
        ...
        9: [ function(a, module, exports) {
            var b = a("extension"), c = a("DefaultElement"), d = a("std/Metadata"), e = a("std/Container"), f = a("std/Mesh"), g = a("std/Texture"), h = a("std/Geometry"), i = [ c, d, e, f, g, h ], j = {};
            j.getExtension = function() {
                var a = new b(null);
                return a.addStructs(i), a;
            }, module.exports = j;
        }, {
            DefaultElement: 12,
            extension: 18,
        ...
        15: [ function(a, module, exports) {
            ...
            "string.prototype.codepointat": 10
        } ],
        ...
        awdlib_std: [ function(a, module, exports) {
            module.exports = function(b) {
                return a("std/_awdlib").set(b), {
                    Container: a("std/Container"),
                    Geometry: a("std/Geometry"),
                    Material: a("std/Material"),
                    Mesh: a("std/Mesh"),
                    Metadata: a("std/Metadata"),
                    Primitive: a("std/Primitive"),
                    Texture: a("std/Texture"),
                    ext: a("std/ext")
                };
            };
        }, {
