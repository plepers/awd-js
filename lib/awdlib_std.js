!function(a) {
    ...
    return function a(b, c, d) {
        ...
        1: [ function(a, module, exports) {
            !function() {
                var b = a("types/properties"), c = a("types/awdString"), d = a("consts"), e = a("types/userAttr"), f = a("BaseElement"), g = f.createStruct(d.ANIMATION_SET, null, {
                    init: function() {
                        this.name = "", this.model = d.MODEL_ANIMATION_SET, this.extras = new e(), this.props = new b({}), 
                        this.animations = [];
                    },
                    read: function(a) {
                        this.name = c.read(a);
                        var b = a.U16();
                        this.props.read(a), this.animations = [];
                        for (var e, f = 0; b > f; f++) {
                            var g = a.U32(), h = this.awd.getAssetByID(g, [ d.MODEL_ANIMATION_STATE ]);
                            if (!h[0]) throw new Error("AnimationSet cannot find animation state reference");
                            e = h[1], this.animations.push(e);
                        }
                        this.extras.read(a);
                    },
                    write: function(a) {
                        c.write(this.name, a), a.U16(this.animations.length), this.props.write(a);
                        for (var b = 0; b < this.animations.length; b++) a.U32(this.animations[b].chunk.id);
                        this.extras.write(a);
                    },
                    getDependencies: function() {
                        for (var a = [], b = this.animations.length, c = 0; b > c; c++) {
        ...
        2: [ function(a, module, exports) {
            !function() {
                var b = a("types/properties"), c = a("types/awdString"), d = a("consts"), e = a("types/userAttr"), f = a("BaseElement"), g = f.createStruct(d.ANIMATOR, null, {
                    init: function() {
                        this.name = "", this.model = d.MODEL_ANIMATOR, this.extras = new e(), this.animatorProps = new e(), 
                        this.animatorProps = new b({
                            1: d.AWD_FIELD_BADDR
                        }), this.props = new b({}), this.targets = [], this.skeleton = null, this.animationSet = null, 
                    ...
                    read: function(a) {
                        ...
                        this.name = c.read(a);
                        var e = a.U16();
                        this.animatorProps.read(a);
                        var f = a.U32(), g = a.U16();
                        this.targets = [];
                        for (var h = 0; g > h; h++) {
                            var i = a.U32();
                            if (b = this.awd.getAssetByID(i, [ d.MODEL_MESH ]), !b[0]) throw new Error("Animator cannot find target reference");
                            this.targets.push(b[1]);
                        }
                        if (this.activeState = a.U16(), this.autoPlay = 0 !== a.U8(), this.props.read(a), 
                        this.extras.read(a), b = this.awd.getAssetByID(f, [ d.MODEL_ANIMATION_SET ]), !b[0]) throw new Error("Animator cannot find AnimationSet reference");
                        if (this.animationSet = b[1], 1 === e) {
                            var j = this.animatorProps.get(1, 0);
                            if (b = this.awd.getAssetByID(j, [ d.MODEL_SKELETON ]), !b[0]) throw new Error("Animator cannot find Skeleton reference");
                            this.skeleton = b[1];
                        }
                    },
                    write: function(a) {
                        c.write(this.name, a), a.U16(1), this.animatorProps.set(1, this.skeleton.chunk.id), 
                        this.animatorProps.write(a), a.U32(this.animationSet.chunk.id), a.U16(this.targets.length);
                        for (var b = 0; b < this.targets.length; b++) a.U32(this.targets[b].chunk.id);
                        a.U16(this.activeState), a.U8(this.autoPlay ? 1 : 0), this.props.write(a), this.extras.write(a);
                    },
                    getDependencies: function() {
                        for (var a = [ this.skeleton, this.animationSet ], b = 0; b < this.targets.length; b++) a.push(this.targets[b]);
                        return a;
                    },
                    toString: function() {
        ...
        3: [ function(a, module, exports) {
            ...
            "../../src/BaseElement": 15,
            "../../src/consts": 21,
            "../../src/types/awdString": 23,
            "../../src/types/matrix": 24,
            "../../src/types/userAttr": 26,
            "../../src/types/vec3": 27
        } ],
        ...
        9: [ function(a, module, exports) {
            !function() {
                function b() {
                    this.id = 0, this.parentId = -1, this.name = "", this.bindPose = new g(), this.props = new c({}), 
                    this.extras = new f();
                }
                var c = a("types/properties"), d = a("types/awdString"), e = a("consts"), f = a("types/userAttr"), g = a("../../src/types/matrix"), h = a("BaseElement"), i = h.createStruct(e.SKELETON, null, {
                    init: function() {
                        this.name = "", this.model = e.MODEL_SKELETON, this.extras = new f(), this.props = new c({}), 
                        this.joints = [], this.jointsByIds = {};
                    },
                    read: function(a) {
                        this.name = d.read(a);
                        var c = a.U16();
                        this.props.read(a), this.joints = [];
                        for (var e = 0; c > e; e++) {
                            var f = new b();
                            f.read(this.awd, a), this.jointsByIds[f.id] = f, this.joints.push(f);
                        }
                        this.extras.read(a);
                    },
                    write: function(a) {
                        d.write(this.name, a), a.U16(this.joints.length), this.props.write(a);
                        for (var b = 0; b < this.joints.length; b++) this.joints[b].write(this.awd, a);
                        this.extras.write(a);
                    },
                    toString: function() {
                ...
                b.prototype = {
                    read: function(a, b) {
                        this.id = b.U16(), this.parentId = b.U16(), this.name = d.read(b), this.bindPose.read(a, b), 
                        this.props.read(b), this.extras.read(b);
                    },
                    write: function(a, b) {
                        b.U16(this.id), b.U16(this.parentId), d.write(this.name, b), this.bindPose.write(a, b), 
                        this.props.write(b), this.extras.write(b);
                    }
                }, module.exports = i;
            }();
        }, {
        ...
        10: [ function(a, module, exports) {
            !function() {
                ...
                var c = a("types/properties"), d = a("types/awdString"), e = a("consts"), f = a("types/userAttr"), g = a("BaseElement"), h = g.createStruct(e.SKELETON_ANIMATION, null, {
                    init: function() {
                        this.name = "", this.model = e.MODEL_ANIMATION_STATE, this.extras = new f(), this.props = new c({}), 
                        this.frames = [];
                    },
                    read: function(a) {
                        this.name = d.read(a);
                        var c = a.U16();
                        this.props.read(a), this.frames = [];
                        for (var e = 0; c > e; e++) {
                            var f = new b();
                            f.read(this.awd, a), this.frames.push(f);
                        }
                        this.extras.read(a);
                    },
                    write: function(a) {
                        d.write(this.name, a), a.U16(this.frames.length), this.props.write(a);
                        for (var b = 0; b < this.frames.length; b++) this.frames[b].write(this.awd, a);
                        this.extras.write(a);
                    },
                    getDependencies: function() {
                        for (var a = [], b = this.frames.length, c = 0; b > c; c++) {
                            var d = this.frames[c];
                            a.push(d.pose);
                        }
                        return a;
                ...
                b.prototype = {
                    read: function(a, b) {
                        var c = b.U32();
                        this.duration = b.U16();
                        var d = a.getAssetByID(c, [ e.MODEL_SKELETON_POSE ]);
                        if (!d[0]) throw new Error("SkeletonAnimation frame cannot find Pose reference");
                        this.pose = d[1];
                    },
                    write: function(a, b) {
                        b.U32(this.pose.chunk.id), b.U16(this.duration);
                    }
                }, module.exports = h;
            }();
        }, {
        ...
        11: [ function(a, module, exports) {
            !function() {
                function b() {
                    this.hasTransform = !1, this.transform = new g();
                }
                var c = a("types/properties"), d = a("types/awdString"), e = a("consts"), f = a("types/userAttr"), g = a("../../src/types/matrix"), h = a("BaseElement"), i = h.createStruct(e.SKELETON_POSE, null, {
                    init: function() {
                        this.name = "", this.model = e.MODEL_SKELETON_POSE, this.extras = new f(), this.props = new c({}), 
                        this.transforms = [];
                    },
                    read: function(a) {
                        this.name = d.read(a);
                        var c = a.U16();
                        this.props.read(a), this.transforms = [];
                        for (var e = 0; c > e; e++) {
                            var f = new b();
                            f.read(this.awd, a), this.transforms.push(f);
                        }
                        this.extras.read(a);
                    },
                    write: function(a) {
                        d.write(this.name, a), a.U16(this.transforms.length), this.props.write(a);
                        for (var b = 0; b < this.transforms.length; b++) this.transforms[b].write(this.awd, a);
                        this.extras.write(a);
                    },
                    toString: function() {
                ...
                b.prototype = {
                    read: function(a, b) {
                        this.hasTransform = 0 !== b.U8(), this.transform.read(a, b);
                    },
                    write: function(a, b) {
                        b.U8(this.hasTransform ? 1 : 0), this.transform.write(a, b);
                    }
                }, module.exports = i;
            }();
        }, {
            ...
            !function() {
                var b = a("types/properties"), c = a("types/awdString"), d = a("consts"), e = a("types/userAttr"), f = a("BaseElement"), g = f.createStruct(d.TEXTURE, null, {
                    ...
                    read: function(a) {
                        ...
                        var d = a.U32();
                        0 === this.textype ? this.url = a.readUTFBytes(d) : (this.data = new ArrayBuffer(d), 
        ...
        13: [ function(a, module, exports) {
            var b = a("../../src/extension"), c = a("../../src/DefaultElement"), d = a("./Metadata"), e = a("./Container"), f = a("./Mesh"), g = a("./Texture"), h = a("./Material"), i = a("./Skeleton"), j = a("./SkeletonPose"), k = a("./SkeletonAnimation"), l = a("./AnimationSet"), m = a("./Animator"), n = a("./Geometry"), o = [ c, d, e, f, g, h, i, j, k, l, m, n ], p = {};
            p.getExtension = function() {
                var a = new b(null);
                return a.addStructs(o), a;
            }, module.exports = p;
        }, {
            "../../src/DefaultElement": 16,
            "../../src/extension": 22,
            "./AnimationSet": 1,
            "./Animator": 2,
            "./Container": 3,
