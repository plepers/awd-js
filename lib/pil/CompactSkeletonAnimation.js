...
var Properties = require("../types/properties"), AwdString = require("../types/awdString"), Consts = require("../consts"), UserAttr = require("../types/userAttr"), BaseElement = require("../BaseElement"), ExtInfos = require("./extInfos"), SkeletonAnimation = BaseElement.createStruct(ExtInfos.COMPACT_SKEL_ANIM, ExtInfos.URI, {
    ...
    write: function(writer) {
        AwdString.write(this.name, writer), writer.U16(this.numFrames), writer.U16(this.numBones), 
        this.props.write(writer);
        var pad = 4 - (writer.ptr + 5) % 4;
        writer.U8(pad);
        for (var i = 0; pad > i; i++) writer.U8(0);
        var dataInt = new Int8Array(this.data.buffer, this.data.byteOffset, this.data.byteLength);
        writer.writeSub(dataInt), this.extras.write(writer);
    },
